...
export default function Body() {
  ...
  const handleLike = async () => {
    ...
    try {
      ...
      const response = await fetch(`/api/like/${userEmail}/${encodeURIComponent(dataHome.image_link.replace('https://firebasestorage.googleapis.com/v0/b/insta-clone-app-91650.appspot.com/o/', ''))}`, {
        method: 'POST',
        headers: {
